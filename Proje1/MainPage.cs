...
namespace Proje1
{
    public partial class MainPage : Form
    {
        ...
        private void button_Click(object sender, EventArgs e)
        {
            ...
            string seans = button.Text;
            string sessionDate = lblDate.Text;
            if (DateTime.Parse($"{sessionDate} {seans}") < DateTime.Now)
            {
                MessageBox.Show("Seçtiğiniz seansın süresi dolmuştur lütfen başka bir seans seçiniz.","Sistem Mesajı",MessageBoxButtons.OK);
                return;
            }
            this.Hide();
            selectionpage.Show();
            selectionpage.ListDetail(movieIndex, seans, sessionDate);
